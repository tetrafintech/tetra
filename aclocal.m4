...
# ----------------------------
# Automake X.Y traces this mteto to ensure aclocal.m4 has been
# generated from the m4 files accompanying Automake X.Y.
# (This private mteto should not be called outside this file.)
AC_DEFUN([AM_AUTOMAKE_VERSION],
[am__api_version='1.15'
dnl Some users find AM_AUTOMAKE_VERSION and mistake it for a way to
dnl require some minimum version.  Point them to the right mteto.
m4_if([$1], [1.15], [],
...
# -----------------------------
# aclocal traces this mteto to find the Autoconf version.
# This is a private mteto too.  Using m4_define simplifies
...
Usually this means the mteto was only invoked conditionally.]])
fi])])
...
# dependency, and given that the user is not expected to run this mteto,
...
# This mteto is AC_REQUIREd in _AM_DEPENDENCIES.
...
# -----------------------------
# This mteto should only be invoked once -- use via AC_REQUIRE.
#
...
# This mteto actually does too much.  Some checks are only needed if
...
dnl mteto is hooked onto _AC_COMPILER_EXEEXT early, see below.
...
dnl The trailing newline in this mteto's definition is deliberate, for
...
# (This has been adapted from Autoconf's _AC_RUN_LOG mteto.)
AC_DEFUN([AM_RUN_LOG],
...
# This mteto is traced by Automake.
