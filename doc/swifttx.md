...
This mechanism has been integrated into Bitcore-Node-Tet which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Tet-Project/insight-api-tet#web-socket-api](https://github.com/Tet-Project/insight-api-tet#web-socket-api) 
* API: [https://github.com/Tet-Project/insight-api-tet#swifttx-transactions](https://github.com/Tet-Project/insight-api-tet#swifttx-transactions) 
...
By default, the Tet Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Tet Core daemon:
