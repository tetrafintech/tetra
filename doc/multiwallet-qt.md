...
In order to support loading of multiple wallets in tet-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tet.cpp.
...
Changes to tet.cpp
----------------------
tet.cpp is the entry point into tet-qt, and as such, will require some minor modifications to provide hooks for
