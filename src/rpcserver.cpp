...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Tet features */
        {"tet", "masternode", &masternode, true, true, false},
        {"tet", "listmasternodes", &listmasternodes, true, true, false},
        {"tet", "getmasternodecount", &getmasternodecount, true, true, false},
        {"tet", "masternodeconnect", &masternodeconnect, true, true, false},
        {"tet", "masternodecurrent", &masternodecurrent, true, true, false},
        {"tet", "masternodedebug", &masternodedebug, true, true, false},
        {"tet", "startmasternode", &startmasternode, true, true, false},
        {"tet", "createmasternodekey", &createmasternodekey, true, true, false},
        {"tet", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"tet", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"tet", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"tet", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"tet", "getmasternodescores", &getmasternodescores, true, true, false},
        {"tet", "mnbudget", &mnbudget, true, true, false},
        {"tet", "preparebudget", &preparebudget, true, true, false},
        {"tet", "submitbudget", &submitbudget, true, true, false},
        {"tet", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"tet", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"tet", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"tet", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"tet", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"tet", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"tet", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"tet", "checkbudgets", &checkbudgets, true, true, false},
        {"tet", "mnsync", &mnsync, true, true, false},
        {"tet", "spork", &spork, true, true, false},
        {"tet", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"tet", "privatesend", &privatesend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use tetd, or the -server option to tet-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> tet-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2289/\n";
}
