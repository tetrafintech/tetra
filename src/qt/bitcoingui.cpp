                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Tetra Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Tet address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tet: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Tetra Core"), this);
    aboutAction->setStatusTip(tr("Show information about Tetra Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Tet"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Tet addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Tet addresses"));
    ...
    openAction->setStatusTip(tr("Open a Tet: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Tetra Core help message to get a list with possible Tet command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Tetra Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Tet network", "", count));
}
...
{
    QString strTitle = tr("Tetra Core"); // default title
